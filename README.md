...
- Khi chạy thử ở local ta sẽ chạy lần lượt: `node .\src\nodels\server.js` và `npm start` ngay trong folder Temp_Up_Web:


<p align="center">
    <img src="./src/image/Server.png">
    <p>Và npm start:</p>   
    <img src="./src/image/npmstart.png">
</p>

- Sau đó ở trình duyệt sẽ tự động bật lên trang chủ của trang web chúng ta chạy ở port `3000` & database chạy ở local   :
